...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "ATLAS Studio" },
      { name: "twitter:title", content: "ATLAS Studio" },
      { property: "og:description", content: "Arquitetura digital para marcas de elite." },
      { name: "twitter:description", content: "Arquitetura digital para marcas de elite." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/b6f91821-edb8-486c-bdeb-30a533fe6c35/id-preview-5da6c1bf--37898079-65fd-4c90-8216-78de59f53adc.lovable.app-1779398157040.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/b6f91821-edb8-486c-bdeb-30a533fe6c35/id-preview-5da6c1bf--37898079-65fd-4c90-8216-78de59f53adc.lovable.app-1779398157040.png" },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Bricolage+Grotesque:opsz,wght@12..96,200..700&family=Archivo:wght@300;400;500;600&display=swap" },
    ],
  }),
